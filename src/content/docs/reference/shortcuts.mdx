...
From v1.2.0 the room map editor ships with a full shortcut set:
...
- [Config file](/docs/reference/config-file) — where shortcut customisations would persist (none configurable in v1.2.0)
