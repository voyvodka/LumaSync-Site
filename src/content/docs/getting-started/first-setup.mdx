...
On success the bridge username and PSK land in your **OS keychain** (macOS Keychain / Windows Credential Manager / Linux Secret Service); the rest of the configuration lives in `~/.config/lumasync/app.json`. Nothing is uploaded. See [Hue pairing](/docs/hue/pairing/) for a deeper walkthrough or troubleshooting.
