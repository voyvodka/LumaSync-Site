...
- **You care about the Hue Sync Mac/PC app being discontinued.** LumaSync speaks the same Entertainment API; if you were a Hue Sync desktop user, you can keep your existing Entertainment Area and just point LumaSync at it. See [Pair your Hue bridge](/docs/hue/pairing).
