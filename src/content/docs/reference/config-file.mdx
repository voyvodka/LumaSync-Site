---
title: Config file
description: Where LumaSync stores its state, what shape the file has, which fields are safe to edit by hand, and how to reset it. Hue credentials live in the OS keychain.
group: reference
order: 20
updated: 2026-09-25
---
