...
LumaSync is a controller, not a store. You bring the lights; we drive them. This page lists what actually works with {LATEST_VERSION} — the checklist is short on purpose.
